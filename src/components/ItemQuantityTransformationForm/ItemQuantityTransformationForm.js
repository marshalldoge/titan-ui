...
class ItemQuantityTransformationForm extends Component {
	constructor(props) {
		super(props);
...
export default withRouter(connect(mapStateToProps,{increaseSaleCount,increaseClientSaleCount})(ItemQuantityTransformationForm));
